...
(function(jQuery)
{
  ...
  jQuery.hasManyAutocomplete.fn.extend({
    init: function(e) {
      ...
      $(document).on('click', '.hma-remove-link', function() {
      ...
      $(e).autocomplete({
        ...
        select: function( event, ui ) {
          e.list_element.append('<li class="ui-state-default"><a href="#" class="hma-remove-link" data-id="'+ui.item.id+'"><span class="hma-remove-link-text">Remove</a> <span class="hma-item-label">'+ui.item.label+'</span></li>');
